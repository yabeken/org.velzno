...
public class AppImportSecondArgumentContext extends QuotesContext{
	public boolean isValid(ISourceModule sourceModule, int offset, CompletionRequestor requestor){
		...
		Matcher m = Pattern.compile("App::import\\s*\\(\\s*([\"\'])(?:Core|Controller|Model|Component|Behavior|Helper|Vendor)\\1\\s*,\\s*[\"\'][\\w\\.]*$").matcher(statementText);
		return m.find();
	}
}
